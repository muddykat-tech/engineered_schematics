...
public class ESMenuTypes {
    public static final DeferredRegister<MenuType<?>> REGISTER = DeferredRegister.create(Registries.MENU, EngineeredSchematics.MODID);
    ...
    public static class ArgContainer<T, C extends IEContainerMenu>
    {
        ...
        private ArgContainer(DeferredHolder<MenuType<?>, MenuType<C>> type, IEMenuTypes.ArgContainerConstructor<T, C> factory)
        {
            this.type = type;
